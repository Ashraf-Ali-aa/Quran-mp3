...
HTML;
	...
	echo <<<HTML
			...
			<p style="float:right;20px;">
				<button onClick="document.location='?do=artists&action=add'; return(false)" id="upload_audio_button" class="btn btn-success" type="button"><i class="icon-plus icon-white"></i>Add new artist</button>
			</p>
