...
HTML;
	...
	$allow_m_audios = intval( $_REQUEST['allow_m_audios'] );
	...
	$allow_full_audios = intval( $_REQUEST['allow_full_audios'] );
	...
	if( $group_name == "" ) {
		...
		allow_m_albums='$allow_m_albums', allow_m_audios='$allow_m_audios', allow_m_users='$allow_m_users', 
		allow_full_artists='$allow_full_artists', allow_full_albums='$allow_full_albums', allow_full_audios='$allow_full_audios' WHERE id='{$id}'" );
	...
	if( $user_group[$id]['allow_m_audios'] ) $allow_m_audios = "checked";
	...
	if( $user_group[$id]['allow_full_audios'] ) $allow_full_audios = "checked";
		...
		<h3>Edit usergroup: {$group_name_value}</h3>
			<form method="post" action="{$form_action}">
				<fieldset>
					...
					<label class="checkbox">
					<input type="checkbox" name="allow_m_audios" {$allow_m_audios} value="1" {$admingroup}> Can manager audios?
					</label>
					<label class="checkbox">
					...
					<label class="checkbox">
					<input type="checkbox" name="allow_full_audios" {$allow_full_audios} value="1" {$admingroup}> Add audio do not need approval?
					</label>
					<label></label>
