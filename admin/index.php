...
<head>
<meta charset="utf-8">
<title>TanCode - Admin Control Panel</title>
	...
	<div class="navbar-inner">
		<div class="container" style="width: auto;"> <a class="brand" href="{$PHP_SELF}?">Admin Control Panel</a>
			<ul class="nav">
              ...
              <li><a href="{$PHP_SELF}?do=templates"><i class="icon-eye-open icon-white"></i> Edit templates</a></li>
            </ul>
...
HTML;
    ...
    <div id="footer">
      <div class="container">
        <p class="muted credit">Copyright &copy; 2013 by <a href="http://tancode.com" target="_blank">TanCode</a></p>
      </div>
    </div>
    </div>
...
if( $user_group[$member_id['user_group']]['allow_m_audios'] ) {
	$menu_bar[] = array(
				"icon" => "icon-list-alt",
				"text" => "Manager audios",
				"link" => "audios"
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Sign in &middot; TanCode Control Panel</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="">
    <meta name="author" content="">
    <!-- Le styles -->
